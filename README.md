...
| @Username | Link | Platform | Followers | Likes | Following | Videos | Views | Last Update | Status | Тематика |
|-----------|------|----------|-----------|-------|-----------|--------|-------|-------------|--------|----------|
...
2. **Unknown usernames для Facebook**
   - ✅ ЧАСТИЧНО ИСПРАВЛЕНО: Улучшено извлечение из URL
   - Некоторые Facebook URL могут не парситься корректно

3. **История и прирост 24ч**
